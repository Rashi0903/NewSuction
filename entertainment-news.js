document.addEventListener('DOMContentLoaded', function() {
    ...
    const totalArticles = 50;  // Total number of articles to fetch
    let isLoading = false;
    ...
    function fetchNews(page) {
        ...
        fetch(`https://newsapi.org/v2/top-headlines?category=entertainment&language=en&pageSize=${pageSize}&page=${page}&apiKey=${apiKey}`)
            .then(response => {
                if (!response.ok) {
